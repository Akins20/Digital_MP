...
function Toast({ notification, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`${colors[type]} border-l-4 text-white p-4 rounded-lg shadow-lg pointer-events-auto animate-slideIn`}
      role="alert"
    >
      <div className="flex items-start">
        ...
        <button
          onClick={onClose}
          className="ml-4 inline-flex flex-shrink-0 text-white hover:text-gray-200 focus:outline-none transition"
        >
